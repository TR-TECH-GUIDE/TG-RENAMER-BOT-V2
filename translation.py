...
This is a Telegram Rename clone of <a href='https://t.me/renametrv2bot'>Rename V2 BOT</a> by {}
...
Type /help for more details."""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "**Thank you for Using [SLBotsOfficial](https://t.me/SLBotsOfficial)'s bot.**"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds.\nUploaded in {} seconds."
    NOT_AUTH_USER_TEXT = "Please /upgrade your subscription."
    NOT_AUTH_USER_TEXT_FILE_SIZE = "Detected File Size: {}. Free Users can only upload: {}\nPlease /upgrade your subscription.\nIf you think this is a bug, please contact <a href='https://t.me/trtechguide'>SLBotsOfficial Bot Supporters</a>"
    ...
    CUSTOM_CAPTION_UL_FILE = "@renametrv2bot"
    NO_CUSTOM_THUMB_NAIL_FOUND = "No Custom ThumbNail found."
    USER_ADDED_TO_DB = "User <a href='tg://user?id={}'>{}</a> added to {} till {}."
    HELP_USER = """Hai <b><i>{}</i></b>, 

I am Renamer bot ✍ by <a href='https://t.me/{}'>My Developer 👨‍🏫</a>
